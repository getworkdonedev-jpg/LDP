...
The `GovernedSession` is the enforcement layer of the LDP architecture (introduced in v2.2.0). It transitions the protocol from "trust-by-origin" to "governed-by-contract."
...
The current spec is v3.1.0. All implementations must declare the spec version they conform to.
